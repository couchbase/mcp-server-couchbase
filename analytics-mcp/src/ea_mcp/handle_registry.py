...
server-side request-id/handle strings and rebuilds the REST calls each time (no
live object retained). This class is deliberately small and self-contained so
