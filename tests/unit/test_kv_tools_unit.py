...
class TestUpsertDocument:
    ...
    async def test_returns_false_on_sdk_error(self) -> None:
        ...
        with patch(
            ...
            result = await upsert_document_by_id(ctx, "b", "s", "c", "doc1", {"a": 1})
...
class TestInsertDocument:
    ...
    async def test_returns_false_on_sdk_error(self) -> None:
        ...
        with patch(
            ...
            result = await insert_document_by_id(ctx, "b", "s", "c", "doc1", {"a": 1})
...
class TestReplaceDocument:
    ...
    async def test_returns_false_on_sdk_error(self) -> None:
        ...
        with patch(
            ...
            result = await replace_document_by_id(ctx, "b", "s", "c", "doc1", {"a": 1})
...
class TestDeleteDocument:
    ...
    async def test_returns_false_on_sdk_error(self) -> None:
        ...
        with patch(
            ...
            result = await delete_document_by_id(ctx, "b", "s", "c", "doc1")
...
class TestSubDocumentLookupIn:
    ...
    async def test_combined_ops_success(self) -> None:
        ...
        with patch(
            ...
            result = await lookup_subdocument(
                ctx,
                "b",
                "s",
                "c",
    ...
    async def test_missing_get_path_reported_not_raised(self) -> None:
    ...
    async def test_exists_path_error_reported_not_raised(self) -> None:
    ...
    async def test_no_paths_returns_error(self) -> None:
        ...
        with patch(
            ...
            result = await lookup_subdocument(ctx, "b", "s", "c", "doc1")

        assert "error" in result
        collection.lookup_in.assert_not_called()

    async def test_lookup_in_sdk_error_returns_error(self) -> None:
    ...
    async def test_count_path_mismatch_reported_not_raised(self) -> None:
...
class TestSubDocumentMutateIn:
    ...
    async def test_combined_ops_success(self) -> None:
        ...
        with patch(
            ...
            result = await mutate_subdocument(
                ctx,
                "b",
                "s",
                "c",
    ...
    async def test_counter_value_read_via_raw_fallback_when_content_as_broken(
        self,
    ) -> None:
    ...
    async def test_array_add_unique_uses_array_addunique_builder(self) -> None:
    ...
    async def test_counter_negative_delta_dispatches_to_decrement(self) -> None:
    ...
    async def test_create_parents_threaded_through(self) -> None:
    ...
    async def test_atomic_sdk_error_returns_error_not_raised(self) -> None:
    ...
    async def test_no_specs_returns_error(self) -> None:
        ...
        with patch(
            ...
            result = await mutate_subdocument(ctx, "b", "s", "c", "doc1")

        assert "error" in result
        collection.mutate_in.assert_not_called()

    async def test_malformed_spec_missing_key_returns_error_not_raised(self) -> None:
